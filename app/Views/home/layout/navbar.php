                ...
                <div class="row mx-0 py-4 g-0 border-bottom">
                  <div class="col-2 position-relative">
                    <picture class="d-block ">
                      <img class="img-fluid" src="<?= base_url(); ?>/assets/images/products/product-cart-1.jpg"
          ...
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <div class="col col-lg-8 py-lg-5">
                      <div class="row py-3 py-lg-0 flex-wrap gx-4 gy-6">
                        ...
                        <div class="col">
                          ...
                          <ul class="list-unstyled">
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Waterproof
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Insulated
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Down
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Softshell
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Casual
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Windproof
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Breathable
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Cleaning &
                                Proofing</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item dropdown-link-all"
                                href="<?= base_url(); ?>/category.html">View All</a></li>
                          </ul>
                        </div>
                        <!-- / menu row-->
                        ...
                        <div class="col">
                          ...
                          <ul class="list-unstyled">
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                ...
                                Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Bodywarmers</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Parkas</a>
                            </li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Baselayers
                                & Thermals</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Winter
                                Hats</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Scarves &
                                Neck</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Gloves &
                                Mitts</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Accessories</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item dropdown-link-all"
                                href="<?= base_url(); ?>/category.html">View All</a></li>
                          </ul>
                        </div>
                        ...
                        <div class="d-none d-xxl-block col">
                          ...
                          <ul class="list-unstyled">
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Lifestyle &
                                Casual</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Walking
                                Shoes</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Running
                                Shoes</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Military
                                Boots</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Fabric
                                Walking Boots</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Leather
                                Walking Boots</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Wellies</a>
                            </li>
                            <li class="dropdown-list-item"><a class="dropdown-item"
                                href="<?= base_url(); ?>/category.html">Winter
                                Footwear</a></li>
                        ...
                        <div class="col">
                          ...
                          <ul class="list-unstyled">
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Insulated Jackets</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Bodywarmers</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Parkas</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Baselayers & Thermals</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Winter Hats</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Scarves & Neck</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Gloves & Mitts</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger"
                                href="<?= base_url(); ?>/category.html">Accessories</a></li>
                            <li class="dropdown-list-item"><a class="dropdown-item text-danger dropdown-link-all"
                                href="<?= base_url(); ?>/category.html">View All</a></li>
                          </ul>
                        </div>
                        <!-- / menu row-->
                          ...
                          <a class="d-block" href="<?= base_url(); ?>/category.html">
                            <picture>
                              <img class="img-fluid d-table mx-auto"
                                src="<?= base_url(); ?>/assets/images/logos/logo-1.svg" alt="">
                            </picture>
                          </a>
                        </div>
                        <div class="me-5 f-w-20">
                          <a class="d-block" href="<?= base_url(); ?>/category.html">
                            <picture>
                              <img class="img-fluid d-table mx-auto"
                                src="<?= base_url(); ?>/assets/images/logos/logo-2.svg" alt="">
                            </picture>
                          </a>
                        </div>
                        <div class="me-5 f-w-20">
                          <a class="d-block" href="<?= base_url(); ?>/category.html">
                            <picture>
                              <img class="img-fluid d-table mx-auto"
                                src="<?= base_url(); ?>/assets/images/logos/logo-3.svg" alt="">
                            </picture>
                          </a>
                        </div>
                        <div class="me-5 f-w-20">
                          <a class="d-block" href="<?= base_url(); ?>/category.html">
                            <picture>
                              <img class="img-fluid d-table mx-auto"
                                src="<?= base_url(); ?>/assets/images/logos/logo-4.svg" alt="">
                            </picture>
                          </a>
                        </div>
                        <div class="me-5 f-w-20">
                          <a class="d-block" href="<?= base_url(); ?>/category.html">
                            <picture>
                              <img class="img-fluid d-table mx-auto"
                                src="<?= base_url(); ?>/assets/images/logos/logo-5.svg" alt="">
                            </picture>
                          </a>
                        </div>
                        <div class="me-5 f-w-20">
                          <a class="d-block" href="<?= base_url(); ?>/category.html">
                            <picture>
                              <img class="img-fluid d-table mx-auto"
                                src="<?= base_url(); ?>/assets/images/logos/logo-6.svg" alt="">
                            </picture>
                          </a>
                        </div>
                      </div>
                            ...
                            <div class="card justify-content-center d-flex align-items-center bg-transparent">
                              <picture class="w-100 d-block mb-2 mx-auto">
                                <img class="w-100 rounded" title=""
                                  src="<?= base_url(); ?>/assets/images/banners/banner-12.jpg"
                                  alt="HTML Bootstrap Template by Pixel Rocket">
                              </picture>
                              <a class="fw-bolder link-cover" href="<?= base_url(); ?>/category.html">Latest
                                Arrivals</a>
                            </div>
                          </div>
                          <div class="col-12 col-md-6">
                            <div class="card justify-content-center d-flex align-items-center bg-transparent">
                              <picture class="w-100 d-block mb-2 mx-auto">
                                <img class="w-100 rounded" title=""
                                  src="<?= base_url(); ?>/assets/images/banners/banner-13.jpg"
                                  alt="HTML Bootstrap Template by Pixel Rocket">
                              </picture>
                              <a class="fw-bolder link-cover" href="<?= base_url(); ?>/category.html">Accessories</a>
                            </div>
                          </div>
                          <div class="col-12 col-md-6">
                            <div class="card justify-content-center d-flex align-items-center bg-transparent">
                              <picture class="w-100 d-block mb-2 mx-auto">
                                <img class="w-100 rounded" title=""
                                  src="<?= base_url(); ?>/assets/images/banners/banner-14.jpg"
                                  alt="HTML Bootstrap Template by Pixel Rocket">
                              </picture>
                              <a class="fw-bolder link-cover" href="<?= base_url(); ?>/category.html">T-Shirts</a>
                            </div>
                          </div>
                          <div class="col-12 col-md-6">
                            <div class="card justify-content-center d-flex align-items-center bg-transparent">
                              <picture class="w-100 d-block mb-2 mx-auto">
                                <img class="w-100 rounded" title=""
                                  src="<?= base_url(); ?>/assets/images/banners/banner-15.jpg"
                                  alt="HTML Bootstrap Template by Pixel Rocket">
                              </picture>
                              <a class="fw-bolder link-cover" href="<?= base_url(); ?>/category.html">Jackets</a>
                            </div>
                          </div>
                        </div>
                        <a href="<?= base_url(); ?>/category.html"
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?= base_url(); ?>/category.html">Tops</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/category.html">Bottoms</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/category.html">Jeans</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/category.html">T-Shirts</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/category.html">Shoes</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/category.html">Accessories</a></li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?= base_url(); ?>/index.html">Homepage</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/category.html">Category</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/product.html">Product</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/cart.html">Cart</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/checkout.html">Checkout</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/login.html">Login</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/register.html">Register</a></li>
                <li><a class="dropdown-item" href="<?= base_url(); ?>/forgotten-password.html">Forgotten Password</a>
                </li>
              </ul>
            </li>
          </ul> <!-- / Menu-->
