      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide position-relative h-100 w-100">
          ...
          <div
            ...
            <div data-swiper-parallax-y="-25">
              <a href="<?= base_url(); ?>/category.html" class="btn btn-psuedo text-white" role="button">Shop New
                Arrivals</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide position-relative h-100 w-100">
          ...
          <div
            ...
            <div data-swiper-parallax-y="-25">
              <a href="<?= base_url(); ?>/category.html" class="btn btn-psuedo text-white" role="button">Shop Latest
                Adidas</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide position-relative h-100 w-100">
          ...
          <div
            ...
            <div data-swiper-parallax-y="-25">
              <a href="<?= base_url(); ?>/category.html" class="btn btn-psuedo text-white" role="button">Why We Are
                Different</a>
            </div>
          </div>
        </div>
        ...
        <div class="marquee-body">
          <div class="marquee-section animation-marquee-50">
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-1.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-2.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-3.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-4.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-5.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-6.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-7.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-8.svg" alt="">
                </picture>
              </a>
            </div>
            <div class="mx-3 mx-lg-5 f-w-24">
              <a class="d-block" href="<?= base_url(); ?>/category.html">
                <picture>
                  <img class="img-fluid d-table mx-auto" src="<?= base_url(); ?>/assets/images/logos/logo-9.svg" alt="">
                </picture>
              </a>
            </div>
          </div>
  ...
  <div class="container-fluid">
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="000">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-7.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
              <p class="title-small mb-2 text-muted">Must Haves</p>
              <h4 class="lead fw-bold">Premium Essentials</h4>
              <a href="<?= base_url(); ?>/category.html" class="btn btn-psuedo align-self-start">Shop Now</a>
            </div>
          </div>
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="100">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-2.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
          ...
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="200">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-3.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
          ...
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="300">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-4.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
          ...
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="400">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-5.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
          ...
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="500">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-6.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
          ...
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="600">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-1.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
          ...
          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="700">
              <picture class="d-block mb-4 img-clip-shape-one">
                <img class="w-100" title="" src="<?= base_url(); ?>/assets/images/categories/category-8.jpg"
                  alt="HTML Bootstrap Template by Pixel Rocket">
              </picture>
    ...
    <div class="position-relative row my-lg-7 pt-5 pt-lg-0 g-8">
      ...
      <div class="col-12 col-md-6 position-relative z-index-20 mb-7 mb-lg-0" data-aos="fade-right">
        ...
        <h3 class="display-3 fw-bold mb-5"><span class="text-outline-dark">OldSkool</span> - streetwear & footwear
          specialists</h3>
        <p class="lead">We are OldSkool, a leading supplier of global streetwear brands, including names such as <a
            href="<?= base_url(); ?>/category.html">Stussy</a>, <a href="<?= base_url(); ?>/category.html">Carhartt</a>,
          <a href="<?= base_url(); ?>/category.html">Gramicci</a>, <a href="<?= base_url(); ?>/category.html">Afends</a>
          and many more.</p>
        <p class="lead">With worldwide shipping and unbeatable prices - now's a great time to pick out something from
          our range.</p>
        <a href="<?= base_url(); ?>/category.html" class="btn btn-psuedo" role="button">Shop New Arrivals</a>
      </div>
      ...
      <div class="row g-4">
        <div class="col-12 col-xl-6 position-relative" data-aos="fade-right">
          <picture class="position-relative z-index-10">
            <img class="w-100 rounded" src="<?= base_url(); ?>/assets/images/banners/banner-sale.jpg"
              alt="HTML Bootstrap Template by Pixel Rocket">
          </picture>
          <div
            ...
            <div class="py-6 px-5 px-lg-10 text-center w-100">
              ...
              <p class="fs-5 fw-light text-white d-none d-md-block">Our yearly flash sale is now on! Grab yourself a
                bargain from the world's leading streetwear brands.</p>
              <a href="<?= base_url(); ?>/category.html" class="btn btn-psuedo text-white" role="button">Shop All Sale
                Items</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-xl-6" data-aos="fade-left">
          <div class="row g-4 justify-content-end">
            <div class="col-12 col-md-6 d-flex">
              <div class="card position-relative overflow-hidden">
                <picture class="position-relative z-index-10 d-block bg-light">
                  <img class="w-100 rounded" src="<?= base_url(); ?>/assets/images/banners/banner-8.jpg"
                    alt="HTML Bootstrap Template by Pixel Rocket">
                </picture>
                <div class="card-overlay">
                  <p class="lead fw-bolder mb-2">The Jordan Delta 2</p>
                  <a href="<?= base_url(); ?>/category.html" class="btn btn-psuedo text-white py-2" role="button">Shop
                    Kicks</a>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 d-flex">
              <div class="card position-relative overflow-hidden">
                <picture class="position-relative z-index-10 d-block bg-light">
                  <img class="w-100 rounded" src="<?= base_url(); ?>/assets/images/banners/banner-9.jpg"
                    alt="HTML Bootstrap Template by Pixel Rocket">
                </picture>
                <div class="card-overlay">
            ...
            <div class="col-12 col-md-6 d-flex">
              <div class="card position-relative overflow-hidden">
                <picture class="position-relative z-index-10 d-block bg-light">
                  <img class="w-100 rounded" src="<?= base_url(); ?>/assets/images/banners/banner-10.jpg"
                    alt="HTML Bootstrap Template by Pixel Rocket">
                </picture>
                <div class="card-overlay">
            ...
            <div class="col-12 col-md-6 d-flex">
              <div class="card position-relative overflow-hidden">
                <picture class="position-relative z-index-10 d-block bg-light">
                  <img class="w-100 rounded" src="<?= base_url(); ?>/assets/images/banners/banner-11.jpg"
                    alt="HTML Bootstrap Template by Pixel Rocket">
                </picture>
                <div class="card-overlay">
