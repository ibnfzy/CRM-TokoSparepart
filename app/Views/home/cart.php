      ...
      <div class="row g-0 vh-lg-100">
                      ...
                      <div class="row mx-0 py-4 g-0 border-bottom">
                        ...
                        <div class="col-2 position-relative">
                          <picture class="d-block border">
                            <img class="img-fluid" src="<?= base_url('uploads/' . $item['gambar']); ?>" alt="Gambar gagal diload, silahkan check jaringan anda">
                          </picture>
                        </div>
                        <div class="col-9 offset-1">
                          <div>
                            <h6 class="justify-content-between d-flex align-items-start mb-2">
                              <?= $item['name']; ?>
                              <a title="Hapus Barang dari keranjang?" href="<?= base_url('remove_item/' . $item['rowid']); ?>"><i class="ri-close-line ms-3"></i></a>
                            </h6>
                            <span class="d-block text-muted fw-bolder text-uppercase fs-9 col-4">Kuantitas : <input type="number" name="qtybutton[<?= $i ?>] class=" form-control" value="<?= $item['qty']; ?>"></span>
                          </div>
        ...
        <div class="col-12 col-lg-5 bg-light pt-lg-10 aside-checkout pb-5 pb-lg-0 my-5 my-lg-0">
          <div class="p-4 py-lg-0 pe-lg-0 ps-lg-5">
            ...
            <button class="btn btn-dark w-100 text-center" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Pilih Metode Pembayaran</button>
            <hr>
            <a href="<?= base_url('clear_cart'); ?>" class="btn btn-outline-danger w-100 text-center mb-3" role="button">Bersihkan
              Keranjang</a>
          </div>
        </div>
      </div>
