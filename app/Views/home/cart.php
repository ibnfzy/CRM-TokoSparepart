        ...
        <div class="pe-lg-5">
          ...
          <nav class="d-none d-md-block">
            <ul class="list-unstyled d-flex justify-content-start mt-4 align-items-center fw-bolder small">
              ...
              <li class="me-4"><a class="nav-link-checkout " href="#">Check Informasi</a></li>
                    ...
                    <div class="col-9 offset-1">
                      <div>
                        ...
                        <span class="d-block text-muted fw-bolder text-uppercase fs-9 col-4">Kuantitas : <input
                            type="number" class="form-control" value="1"></span>
                      </div>
      ...
      <div class="col-12 col-lg-5 bg-light pt-lg-10 aside-checkout pb-5 pb-lg-0 my-5 my-lg-0">
        <div class="p-4 py-lg-0 pe-lg-0 ps-lg-5">
          <div class="pb-4 border-bottom">
            <a href="./checkout.html" class="btn btn-outline-dark w-100 text-center mb-3" role="button">Update
              Keranjang</a>
