            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                  ...
                  <?php else : ?>
                  Pelanggan ini memilih untuk membayar cash.
                  <?php endif ?>
                </p>
              </div>
              <!-- /.col -->
              ...
              <div class="col-12">
                ...
                <button <?= $disable = ($keranjang['bukti_bayar'] != null) ? '' : 'disabled'; ?> type="button"
                  class="btn btn-success pull-right" data-toggle="modal" data-target="#myModal"><i
                    class="fa fa-eye"></i> Lihat Bukti
                  Pembayaran
                </button>
                <?php endif ?>

                <a href="<?= base_url('U/Validasi/' . $keranjang['id_keranjang_beli']); ?>"
                  class="btn btn-danger pull-right">Validasi Pembayaran</a>
              </div>
            </div>
          </div>
        </div>
